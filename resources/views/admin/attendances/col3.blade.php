...
<div class="margin-top-10">
    <strong>Clock In :</strong> <a href="#" id="clock_in_ip{{ $row->employeeID  }}" class="form-edit" data-type="text"  data-container="body" data-original-title="Enter Clock In ">{{ $row->clock_in ?? "Not Set" }}</a><br/>
    <strong>Clock Out :</strong> <a href="#" id="clock_out_ip{{ $row->employeeID  }}" data-type="text"  class="form-edit"  data-container="body" data-original-title="Enter Clock Out">{{ $row->clock_out ?? "Not Set" }}</a><br/>
