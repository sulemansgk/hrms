            ...
            <div class="form-group">
                ...
                <div class="col-md-7 margin-bottom-10">
                    <input type="text" class="form-control only-num" id="overtime_hours" name="overtime_hours"
                           placeholder="@lang("core.hoursClocked")" value="{{$totalHoursClocked->total_hours ?? 0}}">
                </div>
            </div>
            <div class="form-group">
...
<div class="col-md-6">
    <div class="portlet light bordered">
        ...
        <div class="portlet-body">
            ...
            @if($lates > 0)
                @for($counter = 1; $counter <= $lates; $counter++)
                    <div class="form-group">
                        <label class="control-label col-md-2"></label>

                        <div class="col-md-4 margin-bottom-10">
                            <input type="text" class="form-control" placeholder="@lang("core.deduction") 1" name="deductionTitle[]" value="Late Deduction">
                        </div>
                        <div class="col-md-3  margin-bottom-10">
                            <input type="text" class="deduction form-control" placeholder="@lang("core.value")" name="deduction[]" value="{{$dayRate}}">
                        </div>
                        <label class="control-label col-md-1">{{$loggedAdmin->company->currency}}</label>
                    </div>
                @endfor
