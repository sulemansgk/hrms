                ...
                <div class="portlet-body form form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div id="office_clock">
                            ...
                            @foreach ($shifts as $s)
                                <div class="form-group">
                                    <label class="col-md-4 control-label">{{$s->shift_name}} In: </label>

                                    <div class="col-md-3 input-group">
                                        <input type="text" id="start_time"
                                            class="form-control timepicker timepicker-no-seconds"
                                            value="{{$s->time_in??'00:00 AM'}}">
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">{{$s->shift_name}} Out: </label>

                                    <div class="col-md-3 input-group">
                                        <input type="text" id="start_time"
                                            class="form-control timepicker timepicker-no-seconds"
                                            value="{{$s->time_out??'00:00 AM'}}">
                                        <span class="input-group-btn">
