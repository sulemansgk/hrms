            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group" id="abc">
                            <label class="col-md-2 control-label">Maximum Late Allowed </label>
                            <div class="col-md-6">

                                <input type="number" class="form-control" name="max_late_allowed" placeholder="max_late_allowed"
                                value="{{ $company->max_late_allowed}}">
                            </div>
                        </div>
