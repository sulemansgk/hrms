...
@section('mainarea')
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb breadcrumb">
            ...
            <li>
                <span class="active">Device Settings</span>
            </li>
        </ul>
            ...
            <div class="portlet light bordered">
                <div class="portlet-body form form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        @foreach( $company->devices as $d)
                        @php $previousTime = Carbon::parse($d->updated_at)->diffInMinutes($currentTime);

                        
                        @endphp
                        <div class="form-group">
                            <label class="col-md-4 control-label">{{$company->company_name}}</label>
                            <div class="col-md-3 input-group">
                                <input type="text" id="end_time"
                                       class="form-control"
                                       value="{{$d->company_device_id}}">
                                <span class="input-group-btn">
                                    <button class="btn default danger" type="button"><i class="fa fa-power-off" style="color:{{($previousTime > 10)? 'red':'green'}}"></i></button>
                                </span>
                            </div>
