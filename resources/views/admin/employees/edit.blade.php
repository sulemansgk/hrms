    ...
    <div class="row ">
        ...
        <div class="col-md-6 col-sm-6">
            ...
            <div class="portlet light bordered ">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        <i class="fa fa-bolt font-red-sunglo"></i>Device Managment
                    </div>
                    <div class="actions">
                        <a href="javascript:;"
                           onclick="UpdateDetails('{{$employee->id}}','deviceSetting');return false"
                           class="btn btn-sm btn-success ">
                            <i class="fa fa-save"></i> {{trans('core.btnSave')}} </a>
                    </div>
                </div>
                <div class="portlet-body">
                    ...
                    {{--------------------Bank Account Form--------------------------------------------}}
                    {!! Form::open(['method' => 'PUT','class'   =>  'form-horizontal','id'  =>  'deviceSetting_details_form']) !!}

                    <input type="hidden" name="updateType" class="form-control" value="deviceSetting">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                ...
                                {!! Form::select('registered_device', $devices,$employee->registered_device,['class' => 'form-control select2me','id'=>'devices']) !!}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="device_user_is"
                                       placeholder="Device ID" value="{{$employee->registered_device}}">
                            </div>
                        </div>
            ...
            <div class="portlet light bordered ">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        <i class="fa fa-bolt font-red-sunglo"></i>Shift Managment
                    </div>
                    <div class="actions">
                        <a href="javascript:;"
                           onclick="UpdateDetails('{{$employee->id}}','shiftManagment');return false"
                           class="btn btn-sm btn-success ">
                            <i class="fa fa-save"></i> {{trans('core.btnSave')}} </a>
                    </div>
                </div>
                <div class="portlet-body">
                    ...
                    {{--------------------Bank Account Form--------------------------------------------}}
                    {!! Form::open(['method' => 'PUT','class'   =>  'form-horizontal','id'  =>  'shiftManagment_details_form']) !!}

                    <input type="hidden" name="updateType" class="form-control" value="shiftManagment">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <label class="col-md-3 control-label">Shifts</label>

                            <div class="col-md-9">

                                {!! Form::select('shift_id', $shifts,$employee->shift_id,['class' => 'form-control select2me','id'=>'shifts']) !!}
