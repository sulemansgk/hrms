                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        {!! Form::select('registered_device', $devices,null,['class' => 'form-control select2me','id'=>'devices']) !!}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" class="form-control" name="device_user_is"
                                               placeholder="Device ID" value="{{old('device_user_is')}}">
                                    </div>
                                </div>
                            ...
                            <div class="form-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        {!! Form::select('shift_id', $shifts,null,['class' => 'form-control select2me','id'=>'shifts']) !!}
