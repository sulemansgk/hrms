...
Route::group(["namespace" => 'Admin', 'middleware' => ['auth.admin', 'auth.screenlock', 'plan.null'], 'prefix' => 'admin'], function () {
    ...
    Route::get('device_settings', ['as' => 'admin.device_settings.edit', 'uses' => 'CompanySettingsController@device']);
});
// Admin Panel After Login
...
Route::get('/d', 'DeviceController@loopingData')->name('loopingData');